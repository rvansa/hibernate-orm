...
public abstract class AbstractRegionAccessStrategyTest<R extends BaseRegion, S extends RegionAccessStrategy>
	...
	protected class PutFromLoadNode2 extends Thread {
		...
		public PutFromLoadNode2(Object key, CountDownLatch writeLatch1, CountDownLatch writeLatch2, boolean useMinimalAPI, CountDownLatch completionLatch, ExceptionHolder exceptionHolder) {
			this.key = key;
